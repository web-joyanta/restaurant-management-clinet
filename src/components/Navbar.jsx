                    ...
                    {user?.email ? (
                        <div className="dropdown dropdown-end ">
                            ...
                            <ul
                                tabIndex="-1"
                                className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow">
                                <li><Link to="my-foods" className="hover:bg-custom-green hover:text-white text-[15px]">My Foods</Link></li>
                                <li><Link to="add-food" className="hover:bg-custom-green hover:text-white text-[15px]">Add Food</Link></li>
                                <li><Link to="my-orders" className="hover:bg-custom-green hover:text-white text-[15px]">My Orders</Link></li>
                                <li onClick={handleLogOut}><Link className="hover:bg-custom-green hover:text-white text-[15px] text-custom-red">Logout</Link></li>
                            </ul>
                        </div>
                    ) : (
                        <button>
                            <Link to="/auth" className='btn text-white font-medium rounded-md border-0 bg-[#d26f2d]'>Login</Link>
                        </button>
                    )}
