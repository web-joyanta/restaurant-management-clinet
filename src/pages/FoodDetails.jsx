...
const FoodDetails = () => {
    ...
    const { image, name, category, purchase, origin, price, quantity, description, addedBy } = data;
    console.log(image, name, category, purchase, origin, price, quantity);
        ...
        <div className="container mx-auto px-4 py-12 mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <button className="btn btn-orange w-full h-12 text-lg py-2">Purchase Now</button>
                </div>
            </div>
        </div>
    );
